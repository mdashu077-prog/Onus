...
export default function Login({ auth, onLogin }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      // IMPORTANT:
      // Backend/database mein roles exactly ye hain:
      // job-seeker
      // recruiter
      ...
      // App authentication state update
      onLogin?.({
        email: email.trim().toLowerCase(),
        role: selectedRole,
      ...
      <div className="container-center grid gap-8 md:grid-cols-2 items-center">
        ...
        <div className="hidden md:flex flex-col justify-center gap-6">
          <div className="rounded-3xl bg-[#EAF4FF] border border-blue-200 p-8 max-w-md">
            <h3 className="text-3xl font-semibold text-[#2563EB] mb-4">
              Find your dream job
            </h3>

            <p className="text-slate-700">
              Discover opportunities from top companies and
        ...
        <div className="w-full flex items-center justify-center">
          <div className="card w-full max-w-md p-8">
            ...
            <p className="text-sm text-slate-400 mb-6">
              Login to continue your application journey.
            </p>
            ...
            >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-3 text-sm text-blue-200"
                  >
              ...
              {/* Sign In */}
              <button
                className="w-full bg-[#2563EB] text-white py-3 rounded-full text-lg font-semibold tracking-wider shadow-inner transition-colors duration-200 hover:bg-[#60A5FA] disabled:opacity-60"
                type="submit"
                disabled={loading}
              >
                {loading
