      ...
      <div className="container-center px-3 sm:px-4">
        <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-semibold text-secondary sm:text-3xl">Browse by category</h2>
          </div>
          <p className="text-sm text-slate-500">Find relevant job categories instantly.</p>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((category) => (
            <div key={category} className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-lg sm:p-6">
